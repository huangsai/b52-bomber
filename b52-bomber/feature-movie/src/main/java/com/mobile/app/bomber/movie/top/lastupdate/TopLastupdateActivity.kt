 ...
 * 精彩二级页面-为你推荐
 */
class TopLastupdateActivity : MyBaseActivity(), View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private lateinit var recommendListPresenter: LastupdateListPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.layoutToolbar.txtToolbarTitle.text = getString(R.string.movie_text_top_near_label)
        initRecycler()
    }
...
//        list.add(HistoryFriendPresenter(this))
        ...
        recommendListPresenter = LastupdateListPresenter(this, model)
